 ...
 * {@link net.minecraft.nbt.NBTTagCompound}. To account for common indexing scenarios, a key is (optionally) split into
 * a primary and secondary component, which serves two purposes:
 * <ul>
...
public abstract class AEKey {
    ...
    /**
     * Same as {@link #toTag()}, but includes type information so that {@link #fromTagGeneric(NBTTagCompound)} can
     * restore this particular type of key withot knowing the actual type beforehand.
     */
